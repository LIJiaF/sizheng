...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin/info')}}">首页</a> &raquo; 教师信息更新
    </div>
    <!--面包屑导航 结束-->
            ...
            <table class="add_tab">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="tea_job" value="{{$field->tea_job}}">
                        </td>
                    </tr>
                    <tr>
                        <th>教师头像：</th>
                        <td>
                            <input type="text" class="lg" name="tea_src" style="width:450px;" value="{{$field->tea_src}}">
                    ...
                    <tr>
                        ...
                        <td>
                            @if($field->tea_src)
                            <img src="/{{$field->tea_src}}" alt="" id="tea_src_img" style="max-width:200px;max-height:200px;">  
                            @else
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea name="tea_description" style="resize:none;">{{$field->tea_description}}</textarea>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <textarea name="tea_content" id="editor_id" style="width:930px;height:300px;">{{$field->tea_content}}</textarea>
                        </td>
                    </tr>
                    <tr>
                        <th></th>
