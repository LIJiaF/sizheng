...
@section('content')
    ...
    <div class="result_wrap">
        <form action="{{url('admin/news/'.$field->news_id)}}" method="post">
            {{csrf_field()}}
            {{method_field('put')}}
            <table class="add_tab">
                <tbody>
                    <tr>
                        ...
                        <td>
                            <input type="text" class="lg" name="news_title" value="{{$field->news_title}}">
                            <p>文章标题不能超过30个字</p>
                        </td>
                    </tr>
                    <tr>
                        <th>作者：</th>
                        <td>
                            <input type="text" name="news_author" value="{{$field->news_author}}">
                            <p></p>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <textarea name="news_content" id="editor_id" style="width:930px;height:400px;">{{$field->news_content}}</textarea>
                        </td>
                    </tr>
                    <tr>
                        <th></th>
