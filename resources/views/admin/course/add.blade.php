            ...
            <table class="add_tab">
                <tbody>
                    <tr>
                        ...
                        <td>
                            <input type="text" class="lg" name="cou_title">
                            <p>文章标题不能超过30个字</p>
                        </td>
                    </tr>
                    <tr>
                        <th>作者：</th>
                        <td>
                            <input type="text" name="cou_author" value="佚名">
                            <p></p>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <textarea name="cou_content" id="editor_id" style="width:930px;height:400px;"></textarea>
                        </td>
                    </tr>
                    <tr>
                        <th></th>
